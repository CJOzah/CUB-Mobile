            ...
            Column(
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    Provider.of<CountryData>(context).getCountryFlag(15.0, 25.0),
                    SizedBox(width: 5.0,),
                    Text("${Provider.of<CountryData>(context).selectedCountry.name}"),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Use Activation Code",
                    style: TextStyle(fontSize: 20.0),
                    ),
                    SizedBox(width: 10.0,),
                    Tapables(text: "Click Here", size: 20.0, color: primaryRed,
                    ontap: null,
                    ),
                  ],
                ),
                ...
                Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.only(left: 35.0, top: 12.0, bottom: 8.0),
                      ...
                      Padding(
                        padding: const EdgeInsets.only(left: 35.0, top: 12.0, bottom: 6.0),
                        child: MoreItemsBuilder(
